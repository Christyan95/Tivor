...
export const Benefits = () => {
    ...
    return (
        <section id="benefits" className="py-16 lg:py-20 bg-white relative border-y border-slate-100 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
                    ...
                    <div className="lg:w-[45%] lg:pr-10">
                        ...
                        <motion.p
                            ...
                            className="text-slate-600 text-base sm:text-lg font-light leading-relaxed mb-10"
                        >
                        ...
                        <div className="space-y-4">
                            {t.benefits.features.map((item: string, i: number) => (
                                <motion.div
                                    ...
                                    className="flex items-center gap-4 bg-white border border-slate-200 p-4 rounded-2xl shadow-sm hover:border-cyan-200 hover:shadow-md transition-all group cursor-default"
                                >
                                    <div className="w-10 h-10 rounded-full bg-cyan-50 flex items-center justify-center shrink-0 border border-cyan-100 group-hover:scale-110 transition-transform">
                    ...
                    <div className="lg:w-[55%] relative w-full pt-10">
                        <motion.div
                            ...
                            className="bg-slate-900 border border-slate-800 rounded-[40px] p-8 sm:p-10 lg:p-14 relative shadow-[0_30px_80px_-15px_rgba(15,23,42,0.4)] overflow-hidden h-full flex flex-col justify-center"
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl sm:text-3xl lg:text-5xl font-black text-white mb-10 leading-tight tracking-tight">
                                    {t.benefits.impactTitle}
                                </h3>

                                <div className="grid grid-cols-1 xs:grid-cols-2 gap-4 sm:gap-5 mb-10 text-center">
                                    {[
                                        ...
                                        >
                                            <div className="bg-white/5 p-3 rounded-2xl group-hover:scale-110 group-hover:rotate-3 transition-transform">
                                ...
                                <p className="text-slate-300 text-center font-light leading-relaxed border-t border-slate-700 pt-8 text-base px-4">
                                    {t.benefits.conclusion1} <strong className="text-white text-lg sm:text-xl md:text-2xl tracking-[0.2em] font-black uppercase block mt-3">{t.benefits.conclusionStrong}</strong>
                                </p>
                            </div>
                        </motion.div>
                    </div>
