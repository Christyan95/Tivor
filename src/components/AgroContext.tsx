...
export const AgroContext = () => {
    ...
    // Parallax effects for right column items
    const y1 = useTransform(scrollYProgress, [0, 1], [100, -100]);
    const y2 = useTransform(scrollYProgress, [0, 1], [150, -150]);

    return (
        <section ref={containerRef} id="context" className="py-24 lg:py-40 bg-white relative border-y border-slate-100 overflow-hidden">
            ...
            >
                <div className="flex flex-col lg:flex-row gap-20">
                    ...
                    <div className="lg:w-[45%] relative">
                        <div className="lg:sticky lg:top-40 pt-10">
                            ...
                            >
                                ...
                                <div className="relative p-6 pr-8 bg-slate-50 border border-slate-200 shadow-[inset_4px_0_0_0_#10b981] hover:shadow-[inset_6px_0_0_0_#059669] transition-all duration-300 rounded-r-xl group cursor-default">
                    ...
                    {/* Right Column Data Highlights with Parallax */}
                    <div className="lg:w-[55%] grid grid-cols-1 sm:grid-cols-2 gap-8 w-full mt-10 lg:mt-0 relative h-full min-h-[600px] lg:pt-20">
                        {/* 25% PIB */}
                        <motion.div
                            style={{ y: y1 }}
                            className="bg-white border border-slate-200 p-8 pt-10 rounded-[28px] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative group sm:mt-10 lg:h-72"
                        >
                        ...
                        <motion.div
                            style={{ y: y2 }}
                            className="bg-white border border-slate-200 p-8 pt-10 rounded-[28px] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative group lg:h-72"
                        >
                        ...
                        <motion.div
                            style={{ y: y1 }}
                            className="bg-white border border-slate-200 p-8 rounded-[28px] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.05)] hover:shadow-xl hover:-translate-y-2 transition-all duration-300 relative sm:col-span-2 group flex flex-col sm:flex-row items-center gap-8"
                        >
                            <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center text-blue-600 shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-inner block">
