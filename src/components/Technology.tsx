...
export const Technology = () => {
    ...
    return (
        <section id="technology" className="py-24 lg:py-32 bg-white relative border-y border-slate-100 overflow-hidden">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-20">
                    ...
                    <div className="lg:w-[50%]">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="inline-flex items-center gap-3 px-5 py-2 mb-8 text-[10px] sm:text-xs font-bold text-slate-700 bg-slate-50 border border-slate-200/60 rounded-full uppercase tracking-[0.25em] shadow-sm backdrop-blur-sm"
                        >
                            {t.technology.badge}
                        </motion.div>
                        <motion.h2
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            {mergedTools.map((tool: any, i: number) => (
                                <motion.div
                                    ...
                                    className="flex items-start gap-4 p-5 rounded-[24px] bg-white border border-slate-200 shadow-sm hover:shadow-[0_15px_30px_-15px_rgba(6,182,212,0.15)] hover:border-cyan-200 transition-all duration-300 group cursor-default"
                                >
                                    <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 group-hover:bg-cyan-50 group-hover:border-cyan-100 transition-colors">
                                        <tool.icon className="text-slate-600 group-hover:text-cyan-600 w-6 h-6 shrink-0 transition-colors" />
                                    </div>
                                    <div className="pt-1">
                                        <h4 className="text-slate-900 font-bold text-[14px] tracking-tight mb-1">{tool.name}</h4>
                    ...
                    <div className="lg:w-[50%] w-full flex justify-center mt-12 lg:mt-0 relative group">
                        <div className="w-full aspect-square max-h-[600px] border border-slate-200 rounded-[40px] bg-slate-50/40 p-6 relative overflow-hidden flex items-center justify-center shadow-[0_20px_50px_-20px_rgba(0,0,0,0.05)]">
                            ...
                            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
                                <span className="text-slate-900 font-black tracking-[0.2em] text-[10px] uppercase bg-white/80 backdrop-blur-md px-4 py-2 rounded-full border border-cyan-100 shadow-lg">Core Engine 3D</span>
                            </div>
