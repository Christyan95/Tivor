...
export const Contact = () => {
    ...
    const onSubmit = async (data: ContactFormData) => {
        ...
        try {
            ...
            if (!error.message.includes('Inconsistência')) { // Don't track validation errors as system errors if we want cleaner data
                 // actually tracking all hits to the endpoint is good
            }
